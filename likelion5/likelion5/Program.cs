...
namespace likelion5
{
    class Program
    {
        ...
        {
            //숫자 데이터 형식: ㅈ어수와 실수를 다룰 때 사용하는 다양한 타입
            ...
            //decimal highPrecision = 3.1415926535498342984734m;
            ...
            //char number = '9'; //숫자 형태의 문자 저장 (문자 '9', 숫자 아님)
            ...
            //bool isRunnig = true; // 프로그램 실행 상태
            //bool isFinished = false; // 프로그램 종료 상태

            //Console.WriteLine(isRunnig);
